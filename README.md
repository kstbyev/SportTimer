...
> **Примечание:** Скриншоты будут добавлены после тестирования приложения на симуляторе.

### Планируемые скриншоты:
- 🏠 **Главный экран** - приветствие и статистика
- ⏱️ **Экран таймера** - круговой прогресс и управление
- 📈 **История тренировок** - список с поиском
- 👤 **Профиль пользователя** - аватар и настройки
- 🎨 **Анимации** - переходы и интерактивные элементы
