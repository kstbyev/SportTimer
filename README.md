...
<p align="center">
  <img src="https://github.com/user-attachments/assets/eb123a70-91b6-47fe-beed-1076c0f59eac" width="200" alt="Home Screen">
</p>
...
- <p align="center">
  <img src="https://github.com/user-attachments/assets/f51b331a-b191-40f0-bccb-bb006894f09d" width="200" alt="Home Screen">
</p>
...
- Информация о приложении
 ...
 <p align="center">
  <img src="https://github.com/user-attachments/assets/886a072c-ad2e-4989-bfd0-511080eef62b" width="200" alt="Home Screen">
</p>
...
├── BackgroundTaskManager.swift     # Управление фоновыми задачами
├── SoundManager.swift              # Управление звуковыми уведомлениями
...
### Фоновый режим
- BackgroundTasks для продолжения работы таймера
- Background processing для сохранения данных
- Автоматическое завершение фоновых задач
- Интеграция с системными событиями

### Звуковые уведомления
- Системные звуки для интервалов (каждую минуту)
- Звук завершения тренировки
- Поддержка кастомных звуковых файлов
- AVAudioPlayer для воспроизведения
